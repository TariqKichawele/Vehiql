...
const EmiCalculator = ({ price = 1000 }) => {
    ...
    const handleLoanAmountChange = (value) => {
        const newLoanAmount = Math.min(Math.max(value, 1000), 1500000);
    ...
    const handleDownPaymentPercentChange = (value) => {
        const newDownPaymentPercent = Math.min(Math.max(value, 0), 100);
        setDownPaymentPercent(newDownPaymentPercent);
        const newDownPayment = (newDownPaymentPercent / 100) * loanAmount;
        setDownPayment(newDownPayment);
